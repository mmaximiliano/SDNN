...
def main():
    ...
    network_params = [{'Type': 'input', 'num_filters': 1, 'pad': (0, 0), 'H_layer': 34, 'W_layer': 34},
                      {'Type': 'conv', 'num_filters': 8, 'filter_size': 4, 'th': 5.,
                       'alpha': 1., 'beta': 0., 'delay': 0},
                      {'Type': 'pool', 'num_filters': 8, 'filter_size': 5, 'th': 0., 'stride': 1},
                      {'Type': 'conv', 'num_filters': 20, 'filter_size': 6, 'th': 10.,
                       'alpha': 1., 'beta': 0., 'delay': 0},
                      {'Type': 'pool', 'num_filters': 20, 'filter_size': 3, 'th': 0., 'stride': 1},
