...
TEST_F(LollaTest, Hackear_hace_compra_no_hackeable) {
    FachadaLollapatuza l(personas, puestos);

    l.registrarCompra(2,3,2,6); // 1000
    l.registrarCompra(2,3,1,2); // 500
    l.registrarCompra(2,3,5,7); //(con desc)1750
    l.registrarCompra(4,5,1,6); //2500
    l.hackear(2,3); //hackea la segunda compra haciendola no hackeable
    l.hackear(2,3); // hackea la primera
    ...
    EXPECT_EQ(l.gastoEnPuesto(6, 2), 500);
