...
TEST_F(LollaTest, puesto_deja_de_ser_hackeable){
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(9, 5, 13, 6); //persona, item, cantidad, puesto
    l.registrarCompra(9, 5, 3, 2);
    EXPECT_EQ(l.stockEnPuesto(2, 5), 27);
    EXPECT_EQ(l.stockEnPuesto(6, 5), 12);
    l.hackear(9, 5);
    EXPECT_EQ(l.stockEnPuesto(2, 5), 28);
    EXPECT_EQ(l.stockEnPuesto(6, 5), 12);
    l.hackear(9, 5);
    ...
    l.hackear(9, 5);
    EXPECT_EQ(l.stockEnPuesto(2, 5), 30);
    EXPECT_EQ(l.stockEnPuesto(6, 5), 13);
    EXPECT_EQ(l.gastoTotal(l.mayorGastador()), 30000);
}

TEST_F(LollaTest, mayor_gastador_deja_de_serlo) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(4, 5, 2, 6);
    l.registrarCompra(8, 5, 2, 6);
    l.registrarCompra(2, 5, 1, 6);

    //primero se desempata por menor id, mayorGastador es persona 4
    EXPECT_EQ(l.mayorGastador(), 4);
    l.hackear(4, 5);
    EXPECT_EQ(l.mayorGastador(), 8);
    l.hackear(8, 5);
    ...
    EXPECT_EQ(l.gastoTotal(l.mayorGastador()), 2500);

}

TEST_F(LollaTest, mayor_gastador_cuando_nadie_gasto) {
    FachadaLollapatuza l(personas, puestos);
    EXPECT_EQ(l.mayorGastador(), 2);

    EXPECT_EQ(l.gastoTotal(l.mayorGastador()), 0);

}

TEST_F(LollaTest, no_puede_hackear) {
    FachadaLollapatuza l(personas, puestos);
